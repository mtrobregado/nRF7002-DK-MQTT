...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_PAYLOAD_CHANNEL_STRING_MAX_SIZE, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRIGGER_THREAD_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRIGGER_TIMEOUT_SECONDS, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRIGGER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRIGGER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_SAMPLER_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_SAMPLER_MESSAGE_QUEUE_SIZE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_SAMPLER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_SAMPLER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_NETWORK_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_NETWORK_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_NETWORK_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_RECONNECTION_TIMEOUT_SECONDS, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_MESSAGE_QUEUE_SIZE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_WORKQUEUE_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_BROKER_HOSTNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_HELPER_USERNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_CLIENT_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_CLIENT_ID_BUFFER_SIZE, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_PUBLISH_TOPIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_SUBSCRIBE_TOPIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_ERROR_REBOOT_ON_FATAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_ERROR_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_ERROR_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_LED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_LED_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_LED_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 3072);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_HELPER_PORT, 1883);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HW_ID_LIBRARY_SOURCE_NET_MAC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_MAX_FDS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_SOCKETS_POLL_MAX, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_LOG_LEVEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_DEBUG_LEVEL, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_CONTEXT_SNDTIMEO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_STRUCTS_ITERABLE_ACCESS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_RUNTIME_OBSERVERS_POOL_SIZE, 0);
